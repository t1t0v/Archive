...
import naturalism.addon.netherbane.modules.player.fakePlayer.FakePlayerEntity;
...
public class BedBoomer extends Module {
    public BedBoomer(){
        super(NetherBane.COMBATPLUS, "bed-boomer", "");
    }
    ...
    private boolean placeBed(Pair<BlockPos, BlockPos> pair, PlayerEntity target){
        ...
        Rotations.rotate(direction.asRotation(), Rotations.getPitch(pair.getLeft()), () -> {
            ...
            if (testPlace.get()){
                ...
                mc.interactionManager.interactBlock(mc.player, mc.world, Hand.MAIN_HAND, new BlockHitResult(mc.player.getPos(), Direction.DOWN, pair.getRight(), true));
            }
    ...
    private void breakBed(BlockPos pos) {
        ...
        if (testBreak.get()){
            ...
            mc.interactionManager.interactBlock(mc.player, mc.world, handMode.get(), new BlockHitResult(mc.player.getPos(), Direction.DOWN, pos, false));
        }
