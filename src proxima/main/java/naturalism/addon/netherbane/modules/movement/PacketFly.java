...
public class PacketFly extends Module {
    public PacketFly(){
        super(NetherBane.MOVEMENTPLUS, "packet-fly", "");
    }
    ...
    public void onDeactivate() {
        ...
        Modules.get().get(meteordevelopment.meteorclient.systems.modules.world.Timer.class).setOverride(meteordevelopment.meteorclient.systems.modules.world.Timer.OFF);
    }
    ...
    private void onPreTick(TickEvent.Pre event) {
        if (boost.get()) {
            Modules.get().get(meteordevelopment.meteorclient.systems.modules.world.Timer.class).setOverride(boostTimer.get().floatValue());
        } else {
            Modules.get().get(meteordevelopment.meteorclient.systems.modules.world.Timer.class).setOverride(meteordevelopment.meteorclient.systems.modules.world.Timer.OFF);
        }
    }
    ...
    public void onPostTick(TickEvent.Post event) {
        ...
        switch (type.get()) {
            ...
            case ONGROUND -> {
                ...
                for (double i = 0.0625; i < speed.get(); i += 0.262) {
                    double[] dir = PlayerUtil.directionSpeed((float) i);
