...
import naturalism.addon.netherbane.utils.InteractUtil;
import naturalism.addon.netherbane.utils.PlayerUtil;
import naturalism.addon.netherbane.utils.RotationUtil;
...
public class Scaffold extends Module {
    public Scaffold(){
        super(NetherBane.MOVEMENTPLUS, "scaffoldV2", "-");
    ...
    private List<Block> invalid = Arrays.asList(Blocks.AIR, Blocks.COBWEB, Blocks.WATER, Blocks.FIRE, Blocks.WATER, Blocks.LAVA, Blocks.TRAPPED_CHEST,
    ...
    public void onUpdateLessPriorty(TickEvent.Pre event) {
        if (!lastTimer.hasPassed(100D * delay.get()) && InteractUtil.canPlaceNormally()) {
            ...
            rotationUtil.setRotations((float) lastYaw, (float) lastPitch);
        }
    }
