...
import genesis.team.addon.modules.bbc.utils.world.PacketUtils;
import genesis.team.addon.modules.bbc.utils.world.Place;
import genesis.team.addon.modules.bbc.utils.world.Task;
...
public class PacketMine extends BBCModule {
    ...
    public PacketMine() {
        super(Genesis.Bbc, "Mining+", "Automatically breaks blocks via packets");
    }
