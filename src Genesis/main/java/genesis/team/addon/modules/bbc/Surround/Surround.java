package genesis.team.addon.modules.bbc.Surround;
...
import genesis.team.addon.modules.bbc.utils.world.Place;
...
public class Surround extends BBCModule {
    ...
    public Surround() {
        super(Genesis.Bbc, "Surround+++", "Surrounds you in blocks to prevent massive crystal damage.");
    }
