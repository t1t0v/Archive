...
public class BedPlacer extends Module {
    ...
    private boolean placeBed(Pair<BlockPos, BlockPos> pair, PlayerEntity target){
        ...
        Rotations.rotate(direction.asRotation(), Rotations.getPitch(pair.getLeft()), () -> {
            ...
            if (testPlace.get()){
                ...
                mc.interactionManager.interactBlock(mc.player, Hand.MAIN_HAND, new BlockHitResult(Utils.vec3d(pair.getRight()), Direction.UP, pair.getRight(), false));
            }
    ...
    private void breakBed(BlockPos pos) {
        ...
        if (testBreak.get()){
            ...
            mc.interactionManager.interactBlock(mc.player, Hand.OFF_HAND, new BlockHitResult(Utils.vec3d(pos), Direction.UP, pos, true));
        }
