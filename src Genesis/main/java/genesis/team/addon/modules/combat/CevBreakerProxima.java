...
public class CevBreakerProxima extends Module {
    public CevBreakerProxima(){
        super(Genesis.Combat, "cev-miner", "Place a crystal over the player's head and explodes");
