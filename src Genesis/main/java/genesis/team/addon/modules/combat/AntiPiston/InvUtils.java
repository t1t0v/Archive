...
public class InvUtils {
    public static final PlayerInventory inventory = mc.player.getInventory();
    ...
    public static class Action {
        ...
        private void click(int id) {
            mc.interactionManager.clickSlot(mc.player.currentScreenHandler.syncId, id, data, holeType, mc.player);
        }
    }
}