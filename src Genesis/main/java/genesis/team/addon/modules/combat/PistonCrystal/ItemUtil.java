...
public class ItemUtil {
    ...
    public static ArrayList<Item> tnt = new ArrayList<Item>() {{
        add(Items.TNT);
    }};

    public static ArrayList<Item> minecart = new ArrayList<Item>() {{
        add(Items.MINECART);
    }};

    public static ArrayList<Item> minecarttnt = new ArrayList<Item>() {{
        add(Items.TNT_MINECART);
    }};

    public static ArrayList<Item> iron = new ArrayList<Item>() {{
