...
public class TNTAuraProxima extends Module {
    public TNTAuraProxima(){
        super(Genesis.Px, "TNT-TRAX","----------------------------");
    ...
    private boolean isTraped(LivingEntity entity){
        return BlockUtil.getBlock(entity.getBlockPos().add(0, 3, 0)) != Blocks.AIR &&
