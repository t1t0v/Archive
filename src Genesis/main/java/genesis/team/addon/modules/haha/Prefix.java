...
public class Prefix extends Module {
    ...
    public final Setting<String> prefixText = sgGeneral.add(new StringSetting.Builder().name("custom-prefix-text").description("Override the [Copper] prefix.").defaultValue("Copper").visible(customPrefix :: get).build());
    ...
    public Prefix() {
        super(Genesis.Misc, "prefix", "pefix from orion");
    }
    ...
    public void onActivate() {
        switch (mode.get()){
            case All -> {
                ...
                ChatUtils.registerCustomPrefix("genesis.team.addon", this::getPrefix);
