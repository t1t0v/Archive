...
import genesis.team.addon.mixins.VillagerEntityAccessor;
import genesis.team.addon.mixins.HandledScreenAccessor;
...
public class Villager_Aura extends Module {
    ...
    public Villager_Aura() {
        super(Genesis.Misc, "Villager Aura", "Buy and sell items to nearby villagers.");
    }
