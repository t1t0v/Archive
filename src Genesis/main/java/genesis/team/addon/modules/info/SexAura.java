...
public class SexAura extends Module {
    public SexAura(){
        super(Genesis.Info, "sex-aura", "Spam");
    }
    ...
    private void onTick(TickEvent.Pre event){
        ...
        if (messageTick >= messageDelay.get()){
            ...
            if (!pm.get()) ChatUtils.sendPlayerMsg(playerName + " " + texts.get(randomIndex));
            else ChatUtils.sendPlayerMsg("/msg " + playerName + " " + texts.get(randomIndex));
            messageTick = 0;
        }else messageTick++;
