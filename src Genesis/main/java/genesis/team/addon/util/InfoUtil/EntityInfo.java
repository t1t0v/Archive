...
public class EntityInfo {
    ...
    public static boolean isSurrounded(LivingEntity entity) {
        return BlockInfo.isBlastResist(entity.getBlockPos().south())
                && BlockInfo.isBlastResist(entity.getBlockPos().west())
                && BlockInfo.isBlastResist(entity.getBlockPos().east())
                && BlockInfo.isBlastResist(entity.getBlockPos().north())
                && BlockInfo.isBlastResist(entity.getBlockPos().down());
    }

    public static boolean isTrapped(LivingEntity entity) {
        return BlockInfo.isBlastResist(entity.getBlockPos().south().up())
                && BlockInfo.isBlastResist(entity.getBlockPos().west().up())
                && BlockInfo.isBlastResist(entity.getBlockPos().east().up())
                && BlockInfo.isBlastResist(entity.getBlockPos().north().up())
                && BlockInfo.isBlastResist(entity.getBlockPos().up(2));
    }
    ...
    public static boolean isDoubleSurrounded(LivingEntity entity) {
        ...
        return BlockInfo.isBlastResist(blockPos.add(1, 0, 0)) &&
                BlockInfo.isBlastResist(blockPos.add(-1, 0, 0)) &&
                BlockInfo.isBlastResist(blockPos.add(0, 0, 1)) &&
                BlockInfo.isBlastResist(blockPos.add(0, 0, -1)) &&
                BlockInfo.isBlastResist(blockPos.add(1, 1, 0)) &&
                BlockInfo.isBlastResist(blockPos.add(-1, 1, 0)) &&
                BlockInfo.isBlastResist(blockPos.add(0, 1, 1)) &&
                BlockInfo.isBlastResist(blockPos.add(0, 1, -1));
    }
}
