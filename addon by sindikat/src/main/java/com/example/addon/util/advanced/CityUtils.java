...
import static com.example.addon.util.basic.BlockInfo.getState;
import static com.example.addon.util.basic.BlockInfo.isCombatBlock;
import static com.example.addon.util.basic.EntityInfo.getBlockPos;
import static com.example.addon.util.basic.EntityInfo.notNull;
import static com.example.addon.util.basic.Vec3dInfo.getEyeVec;
