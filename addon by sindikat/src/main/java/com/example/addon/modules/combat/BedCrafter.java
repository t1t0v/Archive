...
import com.example.addon.util.advanced.CraftUtils;
...
import static com.example.addon.util.basic.BlockInfo.getBlock;
import static com.example.addon.util.basic.BlockInfo.getSphere;
import static com.example.addon.util.basic.EntityInfo.isInHole;
import static com.example.addon.util.basic.EntityInfo.isMoving;
import static com.example.addon.util.basic.Vec3dInfo.closestVec3d;
import static com.example.addon.util.advanced.CraftUtils.*;
import static com.example.addon.util.advanced.CraftUtils.getEmptySlots;
...
public class BedCrafter extends Module {
    ...
    public BedCrafter() {
        super(Addon.Alliance, "bed-crafter", "Automatically craft beds.");
    }
