...
public class AntiSurroundBlock extends Module {
    ...
    //modes
    public final Setting<AntiSurroundBlock.Mode> mode = sgMode.add(new EnumSetting.Builder<AntiSurroundBlock.Mode>().name("Mode").description("AntiSurroundBlocks mode.").defaultValue(AntiSurroundBlock.Mode.Button).build());
    //render
    ...
    public AntiSurroundBlock() {
        super(Addon.Alliance, "AntiSurroundBlocks", "Automatically trying to fuck players surround.");
    }
